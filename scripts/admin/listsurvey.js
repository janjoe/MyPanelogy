...
$(document).ready(function(){
    ...
    jQuery("#displaysurveys").jqGrid({
        ...
        loadComplete: function(data){
            ...
            $('.footer').outerWidth($('#displaysurveys').outerWidth()+4).css({
                'margin':'0 auto'
            });
    ...
    jQuery("#displaysurveys").jqGrid('filterToolbar', {
        searchOnEnter : false,
        defaultSearch: 'cn'
    });
            ...
            jQuery("#displaysurveys").jqGrid('columnChooser', {
                ...
                bCancel: sCancel,
                    ...
                    if (perm) {
                        ...
                        var hidden = [];
                        $.each($("#displaysurveys").getGridParam("colModel"), function(key, val) {
                            hidden.push( val['hidden'] );
                        });
                        hidden.splice(0,1);
