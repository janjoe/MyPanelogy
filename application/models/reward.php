...
class reward extends LSActiveRecord {
     ...
     * @return string
     */
    public static function instReward($short_title,$title,$type,$image,$points,$amount,$sorder,$is_active,$expiration_date) {
        $oUser = new self;
        ...
        $oUser->sorder = $sorder;        
        $oUser->expiration_date = $expiration_date;
        $oUser->user_id = Yii::app()->getID();        
        ...
        public static function updCategory($category_id, $category_title, $sort_order, $is_Active) {
        $oUser = $this->findByPk((int)$category_id);
