...
class Permission extends LSActiveRecord {
    ...
    public static function getGlobalBasePermissions() {
        ...
        $aPermissions = array(
            ...
            'Country' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage Regions"), 'description' => $clang->gT("Permission to create, view, update and delete Regions"), 'img' => 'country2'),
            'projects' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage Projects"), 'description' => $clang->gT("Permission to create, view, update and delete projects"), 'img' => 'projects'),
            'CMS' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage CMS"), 'description' => $clang->gT("Permission to create, view, update and delete CMS"), 'img' => 'icon-cms'),
            'panellist' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage Panelist"), 'description' => $clang->gT("Permission to create, view, update and delete panelist"), 'img' => 'panellist'),
            'contacts' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage Companies"), 'description' => $clang->gT("Permission to create, view, update and delete companies"), 'img' => 'companies'),
            'Reports' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage Reports"), 'description' => $clang->gT("Permission to create, view, update and delete Reports"), 'img' => 'icon-reports'),
            'rewards' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage Rewards"), 'description' => $clang->gT("Permission to create, view, update and delete Rewards"), 'img' => 'reward'),
            'emailTemp' => array('create' => true, 'read' => true, 'update' => true, 'delete' => true, 'import' => false, 'export' => false, 'title' => $clang->gT("Manage Email Template"), 'description' => $clang->gT("Permission to create, view, update and delete Email Template"), 'img' => 'email-template'),
    ...
    function hasPermission($iEntityID, $sEntityName, $sPermission, $sCRUD, $iUserID=null) {
        ...
        if ($iEntityID > 0 && $sEntityName == 'survey') {
            ...
            if ($iUserID == $aSurveyInfo['owner_id'])
                return true;
        }
        ...
        if ($aPermissionCache[0]['global'][$iUserID]['superadmin']['read_p'])
            return true;
