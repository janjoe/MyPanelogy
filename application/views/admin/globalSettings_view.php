...
<div id='tabs'>
    <ul>
        ...
        <li><a href='#status'><?php $clang->eT("Status"); ?></a></li>
    </ul>
    ...
    <div id='overview'>
        ...
        <div style="display: none">
            ...
            <div class='header ui-widget-header'><?php echo $clang->eT("Updates"); ?></div><br/><ul>
                ...
                if (isset($updateavailable) && $updateavailable == 1 && is_array($aUpdateVersions)) {
                    ...
                    <li><label><span style="font-weight: bold;"><?php echo $clang->gT('The following LimeSurvey updates are available:'); ?></span></label><table>
                            ...
                            foreach ($aUpdateVersions as $aUpdateVersion) {
                                ?>
                                <tr><td>
                                        <?php echo $aUpdateVersion['versionnumber']; ?> (<?php echo $aUpdateVersion['build']; ?>) <?php
                                if ($aUpdateVersion['branch'] != 'master')
                                    $clang->eT('(unstable)'); else
                                    $clang->eT('(stable)');
                                        ?>
                                    </td>
                                    <td>
                                        ...
                                        <?php if ($aUpdateVersion['branch'] != 'master') { ?> <input type='button' onclick="window.open('http://www.limesurvey.org/en/unstable-release/viewcategory/26-unstable-releases', '_blank')" value='<?php $clang->eT("Download"); ?>' /> <?php } else { ?> <input type='button' onclick="window.open('http://www.limesurvey.org/en/stable-release', '_blank')" value='<?php $clang->eT("Download"); ?>' /> <?php } ?>
                                    </td></tr>
                            <?php }; ?>
                        </table>
                </ul>
                ...
                echo sprintf($clang->gT('There was an error on update check (%s)'), $updateinfo['errorcode']);
                ?><br />
        ...
        <ul>
            ...
            <li><label for='defaultquestionselectormode'><?php $clang->eT("Question type selector:") . ((Yii::app()->getConfig("demoMode") == true) ? '*' : ''); ?></label>
                <select name='defaultquestionselectormode' id='defaultquestionselectormode'>
                    ...
                    <?php
                    if ($thisdefaultquestionselectormode == 'default') {
                        echo "selected='selected'";
                    }
                    ?>
                    ...
                    <option value='none'
                    <?php
                    if ($thisdefaultquestionselectormode == 'none') {
                        echo "selected='selected'";
                    }
                    ?>
            ...
            <li><label for='defaulttemplateeditormode'><?php $clang->eT("Template editor:") . ((Yii::app()->getConfig("demoMode") == true) ? '*' : ''); ?></label>
                <select name='defaulttemplateeditormode' id='defaulttemplateeditormode'>
                    <option value='default'
                    <?php
                    if ($thisdefaulttemplateeditormode == 'default') {
                        echo "selected='selected'";
                    }
                    ?>
                    ...
                    <option value='none'
                    <?php
                    if ($thisdefaulttemplateeditormode == 'none') {
                        echo "selected='selected'";
                    }
                    ?>
            ...
            <li <?php if (!isset(Yii::app()->session->connectionID))
                        echo 'style="display: none"'; ?>><label for='iSessionExpirationTime'><?php $clang->eT("Session lifetime for surveys (seconds):"); ?></label>
    ...
    <div id='bounce'><ul>
            ...
            <li><label for='bounceaccounttype'><?php $clang->eT("Server type:"); ?></label>
                <select id='bounceaccounttype' name='bounceaccounttype'>
                    ...
                    <option value='IMAP'
                    <?php
                    if (getGlobalSetting('bounceaccounttype') == 'IMAP') {
                        echo " selected='selected'";
                    }
                    ?>
                    ...
                    <option value='POP'
                    <?php
                    if (getGlobalSetting('bounceaccounttype') == 'POP') {
                        echo " selected='selected'";
                    }
                    ?>
            ...
            <li><label for='bounceencryption'><?php $clang->eT("Encryption type:"); ?></label>
                <select id='bounceencryption' name='bounceencryption'>
                    <option value='off'
                    <?php
                    if (getGlobalSetting('bounceencryption') == 'off') {
                        echo " selected='selected'";
                    }
                    ?>
                            ><?php $clang->eT("Off"); ?></option>
        ...
        <ul>
                ...
                <select name='defaultlang' id='defaultlang'>
                    ...
                    foreach (getLanguageData(true) as $langkey2 => $langname) {
                        ...
                        <option value='<?php echo $langkey2; ?>'
                                <?php if ($actuallang == $langkey2) { ?> selected='selected' <?php } ?>
            ...
            <li><label for='includedLanguages'><?php $clang->eT("Available languages:"); ?></label>
                <table id='languageSelection'>
                    <tr>
                        <td>
                            <select style='min-width:220px;' size='5' id='includedLanguages' name='includedLanguages' multiple='multiple'><?php foreach ($restrictToLanguages as $sLanguageCode) { ?>
                        ...
                        <td >
                            <select size='5' style='min-width:220px;' id='excludedLanguages' name='excludedLanguages' multiple='multiple'>
                                <?php foreach ($excludedLanguages as $sLanguageCode) { ?><option value='<?php echo $sLanguageCode; ?>'><?php echo $allLanguages[$sLanguageCode]['description']; ?></option><?php } ?>
                            </select>
                        </td>
                    </tr>
                </table>
    ...
    <div id='interfaces'>
        <ul>
            ...
            <li>
                <label for='rpc_publish_api'><?php $clang->eT("Publish API on /admin/remotecontrol:"); ?></label>
                <select id='rpc_publish_api' name='rpc_publish_api'>
                    <option value='1'
                    <?php
                    if ($rpc_publish_api == true) {
                        echo " selected='selected'";
                    }
                    ?>
                            ><?php $clang->eT("Yes"); ?></option>
            ...
            <li>
                <?php $Project_Manager = getGlobalSetting('Project_Manager'); ?>
                <label for='Project_Manager'><?php $clang->eT("Select Project Manager User Group"); ?></label>
                <?php
                ...
                echo CHtml::dropDownList('Project_Manager', $Project_Manager, $project_manager_list, array(
                    'prompt' => 'Select Project Manager User Group'
                ));
                ?>
            </li>
            <li>
                <?php $Own_Panel = getGlobalSetting('Own_Panel'); ?>
                <label for='Own_Panel'><?php $clang->eT("Select Internal Company"); ?></label>
                <?php
                //$own_panel = getCompanyDetail();
                $sql = "SELECT * FROM {{view_company}} WHERE company_type LIKE '%V%'";
                $result = Yii::app()->db->createCommand($sql)->query();
                $own_panel_list = CHtml::listData($result, 'contact_id', 'company_name');
                echo CHtml::dropDownList('Own_Panel', $Own_Panel, $own_panel_list, array(
                    'prompt' => 'Select Internal Company',
                    'title' => 'List only companies that are VENDOR'
                ));
                ?>
            </li>
    ...
    <div id='status'>
        <ul>
            <li>
                <?php $project_status_test = getGlobalSetting('project_status_test'); ?>
                <label for='project_status_test'><?php $clang->eT("Project Status Testing"); ?></label>
                <?php
                $sql_project = "SELECT status_id,status_name FROM {{project_status_master}} WHERE status_for = 'p'";
                ...
                echo CHtml::dropDownList('project_status_test', $project_status_test, $project_status_list);
                ?>
            </li>
            <li>
                <?php $project_status_run = getGlobalSetting('project_status_run'); ?>
                <label for='project_status_run'><?php $clang->eT("Project Status Running"); ?></label>
                <?php
                echo CHtml::dropDownList('project_status_run', $project_status_run, $project_status_list);
                ?>
            </li>
            <li>
                <?php $project_status_hold = getGlobalSetting('project_status_hold'); ?>
                <label for='project_status_hold'><?php $clang->eT("Project Status Hold"); ?></label>
                <?php
                echo CHtml::dropDownList('project_status_hold', $project_status_hold, $project_status_list);
                ?>
            </li>
            <li>
                <?php $project_status_completed = getGlobalSetting('project_status_completed'); ?>
                <label for='project_status_completed'><?php $clang->eT("Project Status Completed"); ?></label>
                <?php
                echo CHtml::dropDownList('project_status_completed', $project_status_completed, $project_status_list);
                ?>
            </li>
            <li>
                <?php $project_status_closed = getGlobalSetting('project_status_closed'); ?>
                <label for='project_status_closed'><?php $clang->eT("Project Status Closed"); ?></label>
                <?php
                echo CHtml::dropDownList('project_status_closed', $project_status_closed, $project_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_completed = getGlobalSetting('redirect_status_completed'); ?>
                <label for='redirect_status_completed'><?php $clang->eT("Redirection Status Completed"); ?></label>
                <?php
                $sql_redirection = "SELECT status_id,status_name FROM {{project_status_master}} WHERE status_for = 'r'";
                $result_redirection = Yii::app()->db->createCommand($sql_redirection)->query();
                $redirection_status_list = CHtml::listData($result_redirection, 'status_id', 'status_name');
                echo CHtml::dropDownList('redirect_status_completed', $redirect_status_completed, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_disqual = getGlobalSetting('redirect_status_disqual'); ?>
                <label for='redirect_status_disqual'><?php $clang->eT("Redirection Status Disqualified"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_disqual', $redirect_status_disqual, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_qf = getGlobalSetting('redirect_status_qf'); ?>
                <label for='redirect_status_qf'><?php $clang->eT("Redirection Status Quota FULL"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_qf', $redirect_status_qf, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_redirected = getGlobalSetting('redirect_status_redirected'); ?>
                <label for='redirect_status_redirected'><?php $clang->eT("Redirection Status Redirected"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_redirected', $redirect_status_redirected, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_rej_fail = getGlobalSetting('redirect_status_rej_fail'); ?>
                <label for='redirect_status_rej_fail'><?php $clang->eT("Redirection Status Rejected - Failed SECURITY questions"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_rej_fail', $redirect_status_rej_fail, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_rej_incosist = getGlobalSetting('redirect_status_rej_incosist'); ?>
                <label for='redirect_status_rej_incosist'><?php $clang->eT("Redirection Status Rejected - Inconsistencies"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_rej_incosist', $redirect_status_rej_incosist, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_rej_poor = getGlobalSetting('redirect_status_rej_poor'); ?>
                <label for='redirect_status_rej_poor'><?php $clang->eT("Redirection Status Rejected - Poor OPEN ENDS"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_rej_poor', $redirect_status_rej_poor, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_rej_quality = getGlobalSetting('redirect_status_rej_quality'); ?>
                <label for='redirect_status_rej_quality'><?php $clang->eT("Rejected - Quality issues"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_rej_quality', $redirect_status_rej_quality, $redirection_status_list);
                ?>
            </li>
            <li>
                <?php $redirect_status_rej_speed = getGlobalSetting('redirect_status_rej_speed'); ?>
                <label for='redirect_status_rej_speed'><?php $clang->eT("Rejected - Speeding"); ?></label>
                <?php
                echo CHtml::dropDownList('redirect_status_rej_speed', $redirect_status_rej_speed, $redirection_status_list);
                ?>
            </li>
        </ul>
    </div>
