    ...
    <div class="box w98_per effect7">
        ...
        <p style="padding: 3%;">
            ...
            if ($Pending) {
                ...
                ?>
                Thank you for your time and welcome to the Panelogy!<br/> 
                An email with the subject line 'Welcome to Panelogy' will be sent to you within the next hour regarding completion of your registration.<br/> 
