...
<html>
    <head>
        ...
        ?>
<!--        <link rel="shortcut icon" href="<?php echo App()->baseUrl; ?>styles/favicon.png" type="image/x-icon" />
        <link rel="icon" href="<?php echo App()->baseUrl; ?>styles/favicon.png" type="image/x-icon" />-->
