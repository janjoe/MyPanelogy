...
<!--        <link rel="shortcut icon" href="<?php echo Yii::app()->baseUrl; ?>/styles/admin/favicon.png" type="image/x-icon" />
        <link rel="icon" href="<?php echo $this->createUrl('/'); ?>styles/admin/favicon.png" type="image/x-icon" />-->
        ...
        ?>
<!--        <link rel="icon" href="<?php echo Yii::app()->baseUrl; ?>/images/favicon.png" />-->
