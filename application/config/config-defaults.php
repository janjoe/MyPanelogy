...
// Site Info
$config['sitename'] = 'TheOpinionRoom';     // The official name of the site (appears in the Window title)
...
$config['plstyleurl'] = $config['publicurl'] . 'panellist/';
$config['pltheme'] = 'default';     // This setting specifys the directory where the pl finds it theme/css style files, e.g. setting 'default' points to /panellist/default
